...
Ext.override(Ext.data.Field, {
	...
	// Introduced in Ext 3.x (my support ticket) to solve issues with unset prices
	// form compatibility it is false on default, but for security it should be true!!!
	useNull: true
});

Ext.override(Ext.data.proxy.Server, {
	// prefix all names by '_' to allow differ between data and ext meta information 
	pageParam:				'_page',
	startParam: 			'_start',
	limitParam: 			'_limit',
	groupParam: 			'_group',
...
Ext.override(Ext.form.action.Action, {
	// If set to true (default), the emptyText value will be sent with the form when it is submitted.
	// now you can use emptyText for additional hint that will not be send to server
...
Ext.override(Ext.form.field.Base, {
	...
	afterLabelTextTpl: new Ext.XTemplate(
		// <sup>*</sup>
		'<tpl if="allowBlank === false"><span class="required" data-qtip="Required">*</span></tpl>', 		
		{ disableFormats: true }
	)	 
});
